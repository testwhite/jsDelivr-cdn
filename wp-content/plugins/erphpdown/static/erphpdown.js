    		...
    		$.post(_ERPHP.ajaxurl, {
	            ...
	            if(data.status == '1'){
	            	...
	            	if(that.hasClass('erphp-promo-do-vip')){
	            		...
	            		if(data.type == 1){
	            			$(".erphpdown-type-desc .type-price span").html((oldprice-data.money).toFixed(2)+' <del>'+oldprice.toFixed(2)+'</del>');
	            		}else if(data.type == 2){
	            			$(".erphpdown-type-desc .type-price span").html((oldprice*0.1*data.money).toFixed(2)+' <del>'+oldprice.toFixed(2)+'</del>');
	            		}
	            		...
	            		if(data.type == 1){
	            			...
	            			$(".item-price .tit t").html((oldprice-jmoney).toFixed(2)+' <del>'+oldprice.toFixed(2)+'</del>');
	            			if(lmoney >= (oldprice-jmoney)){
	            				$(".erphpdown-btn-show").hide();
	            				$(".erphpdown-btn-hide").show();
	            			}
	            		}else if(data.type == 2){
	            			$(".item-price .tit t").html((oldprice*0.1*data.money).toFixed(2)+' <del>'+oldprice.toFixed(2)+'</del>');
